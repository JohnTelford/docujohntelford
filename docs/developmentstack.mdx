...
:::caution
The key _Iterative Development_ technologies are [git](glossary#git) and [GitHub](glossary#github).
:::
...
- Each developer makes changes to their repository [clone](glossary#clone). They cannot directly make changes to the central repository.
	...
	- They may deploy their local repository to a private Internet website for stakeholders to see and give feedback.
