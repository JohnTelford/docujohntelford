...
:::caution
The key _Iterative Development_ technologies are [git](glossary#git) and [GitHu`](glossary#github).
:::
...
- Each developer makes changes to their repository [clone](glossary#clone). They cannot directly make changes to the central repository.
	...
	- Team members may deploy their copy of the repository clone with their changes, to a private Internet website for stakeholders to see and give feedback.
...
- The process is managed using [GitHub for Teams](https://github.com/team). When stakeholders determine developers changes, defect fixes, or new features are ready, a GitHub pull request is made by developers to the central project repository. 
	...
	- Project team members and the gatekeeper are notified by GitHub of the [pull](glossary#pull) request. They may examine, comment on, suggest possible changes, and test the code. 
	...
	- Iterations of the central project repository may be deployed by the gatekeeper to a private website for stakeholders viewing.
