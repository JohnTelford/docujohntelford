...
:::info
This website discusses optimizing website project life time costs. It describes using a static site generator for developing and deploying websites. It is based on _Iterative Development_ and _Web Component Technologies_.

The basic idea of _Iterative Development_ is to develop a system through repeated cycles (iterative) and in smaller portions at a time (incremental), allowing iterative development teams to take advantage of what was learned during development of earlier parts or versions of the system.

_Web Component Technologies_ enable creating reusable custom elements, with their functionality encapsulated away from the rest of the code, and utilized in website development.
...
<!--
<img src={/img/iterativedev.png} height={400} width={400} />
-->
...
<!--
<img src={/img/bugFixChart.jpg} height= {400} width={400} />
-->
