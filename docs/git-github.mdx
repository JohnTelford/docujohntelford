...
[Git and GitHub Introduction](https://www.w3schools.com/git/git_intro.asp?remote=github) website is a way to get an understanding of git and Github. Use it to better understand this website page material.
...
The tools used to create and maintain this website are:

- GitHub Desktop   
[GitHub Desktop](https://docs.github.com/en/desktop) Abstracts Github and Git commands

- Fork  
Git repositories are fundamental to a project. [Fork](https://git-fork.com) presents GitHub information differently than GitHub Desktop:  
...
- iA Writer  
Using [iA Writer](material#iawriter) for creating and editing website material and blog posts is faster: 
...
- VScode  
Check programming semantics. Render and test website pages before deploying a private Internet [Preview](deploy#preview) for stake holders. Defects are fixed in iA Writer

Create and maintaining website pages quicker and less error prone using these applications than using VScode alone.
