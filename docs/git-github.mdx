...
[GitHub Desktop](https://docs.github.com/en/desktop) is a Microsoft product available on Mac and Windows. It interacts with GitHub using a GUI instead of the command line or a web browser. Use GitHub Desktop to complete many Git commands such as pushing to, pulling from, and cloning remote repositories, attributing commits, and creating pull requests, with visual confirmation of changes.
...
- GitHub Desktop   
Abstract Github and Git commands

- Fork  
Presents GitHub information differently than GitHub Desktop
