...
1. [Fork](#fork) the central project repository to a team member local project repository in GitHub account
...
2. Push the commits to the cloned local project repository in team member GitHub account
