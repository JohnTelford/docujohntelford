...
### The GitHub Flow
GitHub a collaboration workflow, centered on Pull Requests. This flow works with collaborating tightly-knit team in a single shared repository, or a globally-distributed company or network of strangers contributing to a project through dozens of forks. It is centered on the Topic Branches workflow covered in Git Branching.

GitHub flow for **team members** is:

1. [Fork](#fork) the project repository into GitHub account
1. Create a topic branch from the project repository main branch
1. Make edits and commits to improve the project
1. Push the topic branch to GitHub project repository
1. Open a [Pull Request](#pull-request) on GitHub project repository
1. Team members discuss, and optionally continue committing.

The project gatekeeper merges or closes the Pull Requests, and deploys the project repository to a private website for stack holders viewing. The teams and gatekeeper continues the GitHub Flow process until stack holders agree the project repository is ready for release to the public internet 

Teams may [Pull](#pull) the project repository at anytime to view and test other topic branches.
