...
These Git and Github references explain concepts and commands
...
The core technologies of Iterative Development are, Git and GitHub. The central project repository is controlled by the project gatekeeper, and a content delivery network, like [Cloudflare](#deploy/cloudflare), where Internet production websites and individual team private [Preview](deploy#preview) Internet websites, are deployed.
...
### Git Desktop
 ...
 Git Desktop is an alternative to using [VScode](#vscode) built-in Git commands. It abstract Github and more Git commands. It interacts with GitHub using a GUI instead of the command line or a web browser. It is a Microsoft produc t available on Mac and Windows.
