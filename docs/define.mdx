...
The teams deploy private [Preview](deploy#preview) websites for stakeholders review while creating new, updating, fixing, or exploring new features.  See [Preview Deployments](glossary#preview-deployments)
