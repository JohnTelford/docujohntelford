...
Cloudflare builds websites and deploys them when [git](developmenttools#git) pushes changes from the _Local Repository_ to the _Central Repository_, Cloudflare then automatically builds the website and deploys to the Internet.
